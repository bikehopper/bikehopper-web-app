...
export const CACHE_CONN_STRING = Boolean(process.env.CACHE_CONN_STRING) ? undefined : process.env.CACHE_CONN_STRING;

export const GTFS_REALTIME_TOKEN = Boolean(process.env.GTFS_REALTIME_TOKEN) ? null : process.env.GTFS_REALTIME_TOKEN;
export const GTFS_REALTIME_VEHICLE_POSITION_TOKEN = Boolean(process.env.GTFS_REALTIME_VEHICLE_POSITION_TOKEN) ? null : process.env.GTFS_REALTIME_VEHICLE_POSITION_TOKEN;
export const GTFS_REALTIME_TRIP_UPDATES_TOKEN = Boolean(process.env.GTFS_REALTIME_TRIP_UPDATES_TOKEN) ? null : process.env.GTFS_REALTIME_TRIP_UPDATES_TOKEN;
export const GTFS_REALTIME_SERVICE_ALERTS_TOKEN = Boolean(process.env.GTFS_REALTIME_SERVICE_ALERTS_TOKEN) ? null : process.env.GTFS_REALTIME_SERVICE_ALERTS_TOKEN;
...
export const MAPBOX_ACCESS_TOKEN = Boolean(process.env.MAPBOX_ACCESS_TOKEN) ? null : process.env.MAPBOX_ACCESS_TOKEN;
export const MAPBOX_STYLE_URL = Boolean(process.env.MAPBOX_STYLE_URL) ? null : process.env.MAPBOX_STYLE_URL;
